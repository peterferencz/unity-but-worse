...
void cScreenView::Draw(const Framework::Math::Mat4& view, const Framework::Math::Mat4& projection, const Framework::Math::Mat4& orthoMatrix){
    if(!_enabled) { return; }
    ...
    mat->setUniform("uView", Framework::Math::Mat4(1.0f));
